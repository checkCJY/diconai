...
[`docs/codereviews/2026_05_17/alarm-d-option-flow.md`](../../docs/archive/codereviews/2026_05_17/alarm-d-option-flow.md) 시점까지 명시적 결정 흔적 없이 우선순위에서 밀렸음. 추정 사유:
...
2. **z/cp 는 escalation_source 일치 시만 라벨 채택** — base 가 이미 발화 등급인데 z/cp 발생한 케이스에서 라벨이 driver 와 어긋나는 문제 방지 ([2026-05-19 코드리뷰 §2.1 보강](../../docs/archive/codereviews/2026_05_19/power-5axis-policy-flow.md)).
...
**참조**: [docs/codereviews/2026_05_21/power-ai-multichannel-application-review.md](../../docs/archive/codereviews/2026_05_21/power-ai-multichannel-application-review.md).
...
| [docs/codereviews/2026_05_19/power-5axis-policy-flow.md](../../docs/archive/codereviews/2026_05_19/power-5axis-policy-flow.md) | 5축 코드 흐름 (combine_risk_5axis) |
| [docs/codereviews/2026_05_21/power-ai-multichannel-activation.md](../../docs/archive/codereviews/2026_05_21/power-ai-multichannel-activation.md) | 4채널 활성화 Before/After 코드리뷰 |
| [docs/codereviews/2026_05_21/power-ai-multichannel-application-review.md](../../docs/archive/codereviews/2026_05_21/power-ai-multichannel-application-review.md) | 4채널 적용 검증 보고서 (트러블슈팅 포함) |
