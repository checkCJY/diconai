...
FASTAPI_DEVICE_INFO_URL = (
    "http://localhost:8001/api/sensors/info"  # 기기 정보 (부팅 시 1회)
)
FASTAPI_GAS_URL = "http://localhost:8001/api/sensors/gas"  # 기기 환경 데이터
FASTAPI_POWER_ONOFF_URL = "http://localhost:8001/api/power/onoff"  # ON/OFF 상태
FASTAPI_POWER_CURRENT_URL = "http://localhost:8001/api/power/current"  # 전류
FASTAPI_POWER_VOLTAGE_URL = "http://localhost:8001/api/power/voltage"  # 전압
FASTAPI_POWER_WATT_URL = "http://localhost:8001/api/power/watt"  # 전력(W)
